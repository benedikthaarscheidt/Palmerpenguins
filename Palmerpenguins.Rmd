...
```{r}
stripchart(chinstrapset$body_mass_g~chinstrapset$sex, main="Massdistribution between the biological sexes",method="stack", col=c(2,4))
stripchart(chinstrapset$bill_length_mm~chinstrapset$sex, main="Massdistribution between the biological sexes",method="stack", col=c(2,4))
stripchart(chinstrapset$flipper_length_mm~chinstrapset$sex, main="Massdistribution between the biological sexes",method="stack", col=c(2,4))
stripchart(chinstrapset$bill_depth_mm~chinstrapset$sex, main="Massdistribution between the biological sexes",method="stack", col=c(2,4))
...
```{r}
cWeight = cut(chinstrapset$body_mass_g,breaks=quantile(chinstrapset$body_mass_g,c(0,1/3,2/3,1),na.rm=TRUE),include.lowest=TRUE)

levels(cWeight) = c("light", "medium", "heavy")
table(cWeight,chinstrapset$sex)
```

```{r}
knitr::kable(table(cWeight,chinstrapset$sex))
```
