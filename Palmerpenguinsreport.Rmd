...
In order to achieve all this some crucial measures have to be taken:
The dataset has to be prepared ergo split into the two sexes in order to be able to make comparisons individually. 
