...
=======
<span style="color:red"> **It seems better to express this by writing an actual table rather than expressing it in the form of code output.** </span>
>>>>>>> dca6e450a0784d608af6a3320f8062f75089e747
...
```{r echo=FALSE, results='hide'}
=======
<span style="color:red">**The same goes for function implementation. There is a need to hide it from view. If you hide this, the description will also need to change. Detlef said he didn't want the R to look like a real paper report. Check Detlef's email. The same goes for your works after this.**</span>
...
The chi-square goodness-of-fit test is calculated using the formula:

\[ \chi^2 = \sum \frac{(O_i - E_i)^2}{E_i} \]

where \(\chi^2\) is the test statistic, \(O_i\) is the observed frequency in category \(i\), and \(E_i\) is the expected frequency in category \(i\) under the assumed distribution.
...
_In the discussion we need to drive the colclusions and find the right words for proving our hypothesis. Here include the comparison with the literture data of other birds._

## Sexual dimorphism in Chinstrap penguin

_Here, sexual dimorphism in our chinstrap penguins will be compared by size and conclusions and discussions will be presented._
...
_We illustrate here, using the small SDI averages table above, that compared to other bird species, songbirds exhibit relatively small SSD. This can also be explained by differences in sexual roles and courtship methods among penguins. Citing literature, we explain why songbirds exhibit such minor sexual dimorphism. These may include brain size, sexual roles, and the songbird's courtship behavior and song._
